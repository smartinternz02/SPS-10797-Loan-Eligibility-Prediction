	...
	public static void main(String[] args) {
     // TODO Auto-generated method stub
        ...
        //Reading the training dataset in a dataframe using Tablesaw
			Table loantrain_data =Table.read().csv("C:\\.eclipse\\org.ml\\src\\main\\java\\org\\ml\\train_data.csv");
         ...
         //Reading the test dataset in a dataframe using tablesaw
			Table loantest_data =Table.read().csv("C:\\.eclipse\\org.ml\\src\\main\\java\\org\\ml\\test_data.csv");
			System.out.println();
           ...
           // Box Plot for variable ApplicantIncome of training data set
            ...
            BoxTrace trace4=BoxTrace.builder(loantest_data.categoricalColumn("LoanAmount"),loantest_data.nCol("ApplicantIncome")).build();
